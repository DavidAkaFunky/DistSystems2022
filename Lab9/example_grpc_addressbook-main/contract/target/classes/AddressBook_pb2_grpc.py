...
class AddressBookServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.deletePerson = channel.unary_unary(
                '/pt.tecnico.addressbook.grpc.AddressBookService/deletePerson',
                request_serializer=AddressBook__pb2.DeletePersonRequest.SerializeToString,
                response_deserializer=AddressBook__pb2.DeletePersonResponse.FromString,
                )
        self.removeAll = channel.unary_unary(
                '/pt.tecnico.addressbook.grpc.AddressBookService/removeAll',
                request_serializer=AddressBook__pb2.RemoveAllRequest.SerializeToString,
                response_deserializer=AddressBook__pb2.RemoveAllResponse.FromString,
                )
...
def add_AddressBookServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'deletePerson': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=AddressBook__pb2.DeletePersonRequest.FromString,
                    response_serializer=AddressBook__pb2.DeletePersonResponse.SerializeToString,
            ),
            'removeAll': grpc.unary_unary_rpc_method_handler(
                    servicer.removeAll,
                    request_deserializer=AddressBook__pb2.RemoveAllRequest.FromString,
                    response_serializer=AddressBook__pb2.RemoveAllResponse.SerializeToString,
            ),
    }
...
class AddressBookService(object):
    ...
    def deletePerson(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pt.tecnico.addressbook.grpc.AddressBookService/deletePerson',
            AddressBook__pb2.DeletePersonRequest.SerializeToString,
            AddressBook__pb2.DeletePersonResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def removeAll(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pt.tecnico.addressbook.grpc.AddressBookService/removeAll',
            AddressBook__pb2.RemoveAllRequest.SerializeToString,
            AddressBook__pb2.RemoveAllResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
